...
if(isset($_POST['adminLogin'])){
  ...
  if (mysqli_num_rows($result_find_admin) == 1) {
    ...
    if($adminPassword == $row['password']){
      ...
      $_SESSION['hostelname'] = $row['hostel'];
