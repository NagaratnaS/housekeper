...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800" rel="stylesheet">  <!-- Font purpose -->
    ...
    <div class="row parent-row">
      ...
      <div class="col s12 l5">
        <div class="center-align form-align">
          ...
          <div class="row">
            <form action="server.php" method="POST" autocomplete="off" class="col s12">
