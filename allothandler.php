<?php
  ...
  require("db.php");
    ...
    if(isset($_POST['regSubmit']) && isset($_SESSION['username'])){
      ...
      $password =  mysqli_real_escape_string($db, $_POST['regPassd']);
    ...
    if(isset($_POST['regKeeperSubmit']) && isset($_SESSION['username'])){
      ...
      $worker_id = mt_rand(100000,999999);
      $reg_query = "Insert into housekeeper (worker_id,name, hostel, floor) values ('$worker_id','$name', '$hostel_name', '$floornumber')";
      $reg_result = mysqli_query($db, $reg_query);
      if($reg_result){
