          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
<?php 
$query = "select * from student join cleanrequest using(rollnumber) join housekeeper using(worker_id)  join feedback using(request_id) join complaints using(feedback_id)";
